            ...
            <div className="p-8 overflow-y-auto custom-scrollbar flex-1 relative">
              <div className="text-xl leading-loose text-slate-300 font-serif">
                ...
                <p>
                  ...
                  He's doing in the world. We've all desired to say the right
                  word or do the right thing when it is most needed, but we all
                  know what it feels like to fail to recognize and respond to
                  God's promptings.
                </p>
                <br></br>
                <p>
                  ...
                  focused only on our schedule, our problems, and our desires.
                  So as those who are learning how to join God’s activity in the
                ...
                <br></br>
                <p>
                  Before you go to work or go to lunch, before you go into a
                  store or the gym, and before you walk in the door of your
                  house, pray that prayer. Then spend your time in those
                  environments and around the people there to{" "}
                  <strong>
                ...
                <p>
                  ...
                  have agendas for why we’re there. We go to the store to shop,
                  we go to the gym to exercise, we go to the office to work, and
                  we go to our neighborhood to rest. Our will determines how we
                  behave and how we view the people in those environments.
                </p>
                <br></br>
                <p>
                  Throughout our year, we’re going to focus on the different
                  spheres of our orbit, but for this month we want to begin
                  simply by identifying who is in those spheres. So as you go
                  throughout your month praying this prayer of invitation, start
                  to notice the places you regularly go, and the people who fill
                  those spaces.
                </p>
              </div>
            </div>
